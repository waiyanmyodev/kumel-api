...
export class RequestHelpController {
  ...
  create(@Body() createRequestHelpDto: CreateRequestHelpDto, @UploadedFile() file: Express.Multer.File) {
  ...
  @UseInterceptors(FileInterceptor("file", uploadToLocal))
  update(@Param('id') id: string, @Body() updateRequestHelpDto: UpdateRequestHelpDto,     @UploadedFile() file: Express.Multer.File) {
    const updateData = {
