...
export const GENERAL_RESPONSE: GeneralResponseType = {
  ...
  FAILEDL_SEND_MESSAGE: {
    status: 'FAIL_SEND_MESSAGE',
    message: 'Message sending failed!',
  },
  FAILED_CREATE_SMS_LOG: {
    status: 'FAILED_CREATE_SMS_LOG',
    message: 'Failed to create sms log',
  },
  FAILED_UPDATE_SMS_LOG: {
    status: 'FAILED_UPDATE_SMS_LOG',
    message: 'Failed to update sms log',
  },
  FAILED_FETCH_SMS_LOG: {
    status: 'FAILED_FETCH_SMS_LOG',
    message: 'Failed to fetch sms log',
  },
  FAILED_FETCH_CDR_LOG: {
    status: 'FAILED_FETCH_CDR_LOG',
    message: 'Failed to fetch cdr log',
  },
  FAILED_DELETE_SMS_LOG: {
    status: 'FAILED_DELETE_SMS_LOG',
    message: 'Failed to delete sms log',
  },
  FAILED_CREATE_CDR_LOG: {
    status: 'FAILED_CREATE_CDR_LOG',
    message: 'Failed to create cdr log',
  },
  FAILED_UPDATE_CDR_LOG: {
    status: 'FAILED_CREATE_CDR_LOG',
    message: 'Failed to create cdr log',
  },
  FAILED_DELETE_CDR_LOG: {
    status: 'FAILED_DELETE_CDR_LOG',
    message: 'Failed to delete cdr log',
  },
  FAILED_FIND_PRODUCT_BY_OFFER_CODE: {
    status: 'FAILED_FIND_PRODUCT_BY_OFFER_CODE',
    message: 'Failed to find product by offer code ',
  },
  FAILED_FIND_PRODUCT_BY_ID: {
    status: 'FAILED_FIND_PRODUCT_BY_ID',
    message: 'Failed to find product by id',
  },
  FAILED_SUBSCRIBE_SDP: {
    status: 'FAILED_SUBSCRIBE_SDP',
    message: 'Failed to subscribe',
  },
  FAILED_FIND_SUBSCRIBER: {
    status: 'FAILED_FIND_SUBSCRIBER',
    message: 'Failed to find subscriber!',
  },
  FAILED_UNSUBSCRIBE_SDP: {
    status: 'FAILED_UNSUBSCRIBE_SDP',
...
export class FailedCreateRoleException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_CREATE_ROLE);
  }
}

export class FailedCreatePermissionException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_CREATE_PERMISSION);
  }
}

export class FailedSendMessageException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILEDL_SEND_MESSAGE);
  }
}

export class FailedFetchSmsLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_FETCH_SMS_LOG);
  }
}

export class FailedCreateSmsLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_CREATE_SMS_LOG);
  }
}

export class FailedUpdateSmsLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_UPDATE_SMS_LOG);
  }
}

export class FailedFindOneSmsLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_FETCH_SMS_LOG);
  }
}

export class FailedDeleteSmsLogExpection extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_DELETE_SMS_LOG);
  }
}

export class FailedFetchCdrLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_FETCH_CDR_LOG);
  }
}

export class FailedCreateCdrLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_CREATE_CDR_LOG);
  }
}

export class FailedUpdateCdrLogException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_UPDATE_CDR_LOG);
  }
}

export class FailedDeleteCdrLogExpection extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_DELETE_CDR_LOG);
  }
}

export class FailedFindProductByOfferCodeException extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_FIND_PRODUCT_BY_OFFER_CODE);
  }
}

export class FailedFindProductByIdExpection extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_FIND_PRODUCT_BY_ID);
  }
}

export class FailedToSubscribeSDPExpection extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_SUBSCRIBE_SDP);
  }
}

export class FailedToFindSubscriberExpection extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_FIND_SUBSCRIBER);
  }
}

export class FailedToUnSubscribeSDPExpection extends BadRequestException {
  constructor() {
    super(GENERAL_RESPONSE.FAILED_UNSUBSCRIBE_SDP);
  }
}
